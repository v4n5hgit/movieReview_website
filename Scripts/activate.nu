...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\Git_projects\WebD\Movie_review_self\movie_review'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\Git_projects\WebD\Movie_review_self\movie_review\Scripts\deactivate.nu'
